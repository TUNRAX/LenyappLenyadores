...
public class MenuLenyador extends AppCompatActivity {
                ...
                final Runnable runnable = new Runnable() {
                    ...
                    public void run() {
                        try {
                            ...
                            String url = "http://865e33a1.sa.ngrok.io/encontrarPedidos.php?idProv=" + id;
                                    ...
                                    public void onClick(DialogInterface dialog, int which) {
                                        switch (which) {
                                            case DialogInterface.BUTTON_POSITIVE:
                                                ...
                                                RequestQueue queue = Volley.newRequestQueue(MenuLenyador.this);
                                                String url = "http://865e33a1.sa.ngrok.io/actualizarValidado.php?validado=" + newVerificado[0] + "&idHistorial=" + idHistorial[0];
                                            ...
                                            case DialogInterface.BUTTON_NEGATIVE:
                                                ...
                                                String url1 = "http://865e33a1.sa.ngrok.io/actualizarValidado.php?validado=" + newVerificado[0] + "&idHistorial=" + idHistorial[0];
    ...
    public String obtenerPedido(int id) {
        ...
        try {
            ...
            url = ("http://865e33a1.sa.ngrok.io/encontrarPedidos.php?idProv=" + id);
    ...
    public void cambiarValidado(int idHistorial, int newVerificado) {
        ...
        try {
            ...
            url = ("http://865e33a1.sa.ngrok.io/actualizarValidado.php?validado=" + newVerificado + "&idHistorial=" + idHistorial);
            url = url.replaceAll(" ", "%20");
            URL sourceUrl = new URL(url);
            HttpURLConnection connection = (HttpURLConnection) sourceUrl.openConnection();
            respuesta = connection.getResponseCode();
